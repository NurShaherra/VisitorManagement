...
/* DONE BY 15017484 */
public class Add5Visitor extends AppCompatActivity {
    EditText etName, etEmail, etMobile, etName2, etEmail2, etMobile2, etName3, etEmail3, etMobile3, etName4, etEmail4, etMobile4,  etName5, etEmail5, etMobile5;
    Button btnSave;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etName5 = (EditText) findViewById(R.id.editTextUserName5);
        etEmail5 = (EditText) findViewById(R.id.editTextEmail5);
        etMobile5 = (EditText) findViewById(R.id.editTextUnit5);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String email5 = etEmail5.getText().toString();
                String mobile5 = etMobile5.getText().toString();
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        new SendMail().execute();
                                        request = new HttpRequest(url);
                                        request.addData("fullname", name5);
                                        request.addData("email", email5);
                                        request.addData("mode", "");
                                        request.addData("mobile", mobile5 + "");
                                        request.addData("userId", id + "");
                                        request.setMethod("POST");
                                        request.execute();
                                        ...
                                        try {
                                            ...
                                            jsonObj = (JSONObject) new JSONTokener(jsonString).nextValue();
                                            String visitor_id5 = jsonObj.getString("just_created_id");
                                            sendEmail = email5;
                                            visitor_id = visitor_id5;
                                            new SendMail().execute();
